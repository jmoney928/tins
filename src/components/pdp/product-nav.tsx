    ...
    <header className="fixed inset-x-0 top-0 z-40 px-4 pt-4 sm:px-6 sm:pt-5">
      <nav className="glass-edge mx-auto flex max-w-7xl items-center gap-4 rounded-full bg-paper/80 px-4 py-3 backdrop-blur-xl sm:px-5">
        <Link
          ...
          className="flex items-center gap-2.5 text-fog transition-colors duration-300 hover:text-frost"
        >
        ...
        <button
          ...
          className="hairline relative ml-auto rounded-full border p-2.5 text-fog transition-colors duration-300 hover:text-frost"
        >
